        ...
        child: InkWell(
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              // 宽度响应式：手机端（<700px）缩放布局宽度
              final useScale = availableWidth < 700
                  ? (availableWidth / 752.0).clamp(0.40, 1.0)
                  : 1.0;

              final checkboxWidth = 48.0 * useScale;
              final imageSize = (80.0 * useScale).clamp(44.0, 80.0);
              final priceWidth = (100.0 * useScale).clamp(80.0, 100.0);
              final qtyWidth = (120.0 * useScale).clamp(96.0, 120.0);
              final subtotalWidth = (100.0 * useScale).clamp(80.0, 100.0);
              final actionWidth = (80.0 * useScale).clamp(48.0, 80.0);

              return Padding(
                padding: EdgeInsets.symmetric(horizontal: 12 * useScale, vertical: 12),
                child: Row(
                  children: [
                    SizedBox(
                      width: checkboxWidth,
